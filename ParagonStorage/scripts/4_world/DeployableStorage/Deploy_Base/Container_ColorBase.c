class Container_ColorBase : OZ_Container_Base
{
	...
	void SoundOpenPlay()
	{
		EffectSound sound =	SEffectManager.PlaySound( "Paragon_ContainerOpen_Soundset", GetPosition() );
		sound.SetSoundAutodestroy( true );
	}
	
	void SoundClosePlay()
	{
		EffectSound sound =	SEffectManager.PlaySound( "Paragon_ContainerClose_Soundset", GetPosition() );
		sound.SetSoundAutodestroy( true );
	}

class Compound_Gate_ColorBase : OZ_Container_Base
{
	...
	void SoundOpenPlay()
	{
		EffectSound sound =	SEffectManager.PlaySound( "Paragon_Compound_Soundset", GetPosition() );

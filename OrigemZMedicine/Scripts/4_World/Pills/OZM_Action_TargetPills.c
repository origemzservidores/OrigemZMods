class OZM_Action_TargetPillsCB : ActionSingleUseBaseCB
{
...
class OZM_Action_TargetPills : ActionSingleUseBase
{
	const int DEFAULT_CONSUMED_QUANTITY = 1;
	
	void OZM_Action_TargetPills()
	{
		m_CallbackClass = OZM_Action_TargetPillsCB;

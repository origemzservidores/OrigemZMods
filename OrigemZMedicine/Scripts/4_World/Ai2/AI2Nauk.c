class OZM_Ai2_Nauk extends ItemBase
{
    static const int STOP_N_BLEEDS = 3;
    ...
    override void SetActions()
    {
        ...
        AddAction( ActionAI2NaukSelf );
        AddAction( ActionAI2NaukTarget );
    }
    ...
    override void OnApply( PlayerBase player )
    {
		...
		if (curren_heath < max_health)
			player.AddHealth("GlobalHealth", "Health", max_health * 0.7);
    }
}
...
class CfgVehicles
{
	...
	class OZM_BandageDressing_4: BandageDressing
	{
		scope=2;
		displayName="Bandagem 'Militar'";
		...
		model="\OrigemZMedicine\Bandage\Bandage_4\Bandage.p3d";
		inventorySlot[]=
		{
			"MedicalBandage"
		};
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"OrigemZMedicine\Bandage\Bandage_4\data\Bandage.rvmat"
							}
						},

...
class CfgVehicles
{
	...
	class OZM_BandageDressing_5: BandageDressing
	{
		scope=2;
		displayName="Bandagem 'Médica'";
		...
		model="OrigemZMedicine\Bandage\Bandage_5\Bandage5.p3d";
		inventorySlot[]=
		{
			"MedicalBandage"
		};
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"OrigemZMedicine\Bandage\Bandage_5\Data\Bandage.rvmat"
							}
						},

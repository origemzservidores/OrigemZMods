...
class CfgVehicles
{
	...
	class OZM_BandageDressing_3: BandageDressing
	{
		scope=2;
		displayName="Bandagem 'Elástica'";
		...
		model="\OrigemZMedicine\Bandage\Bandage_3\Bandage.p3d";
		inventorySlot[]=
		{
			"MedicalBandage"
		};
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"OrigemZMedicine\Bandage\Bandage_3\data\Bandage.rvmat"
							}
						},

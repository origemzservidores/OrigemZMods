...
class CfgVehicles
{
	...
	class OZM_BandageDressing_2: BandageDressing
	{
		scope=2;
		displayName="Bandagem 'Elástica Médica'";
		...
		model="\OrigemZMedicine\Bandage\Bandage_2\Bandage.p3d";
		inventorySlot[]=
		{
			"MedicalBandage"
		};
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"OrigemZMedicine\Bandage\Bandage_2\data\Bandage.rvmat"
							}
						},

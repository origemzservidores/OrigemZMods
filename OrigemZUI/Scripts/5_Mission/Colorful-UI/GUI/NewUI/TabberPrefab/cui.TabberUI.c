modded class TabberUI extends ScriptedWidgetEventHandler
{
	...
	override int AddTab( string name )
	{
		...
		Widget control = GetGame().GetWorkspace().CreateWidgets( "OrigemZUI/GUI/layouts/new_ui/tabber_prefab/cui.tab_control.layout", m_Root.FindAnyWidget( "Tab_Control_Container" ) );

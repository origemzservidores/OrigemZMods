modded class OptionsMenu extends UIScriptedMenu
{
	...
	override Widget Init()
	{
		...
		layoutRoot		= GetGame().GetWorkspace().CreateWidgets("OrigemZUI/gui/layouts/new_ui/options/pc/cui.options_menu.layout", null);
		...
		// Fix temporario para botão sempre detectar alterações quando abre menu
		GetGame().GetCallQueue(CALL_CATEGORY_GUI).CallLater(Apply, 100, false);
		return layoutRoot;
	}
